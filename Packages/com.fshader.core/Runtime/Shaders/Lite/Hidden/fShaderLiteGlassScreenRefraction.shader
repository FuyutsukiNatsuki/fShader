Shader "Hidden/fShader/Lite/GlassScreenRefraction"
{
    Properties
    {
        ...
        _RefractionStrength ("Screen Refraction", Range(0, 1)) = 0.12
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma fragment FSFragGlassScreen
