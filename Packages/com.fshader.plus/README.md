...
PlusはWater / Ice / Glassへ追加ディテール、距離Fade、Box Projected Reflection Probe、Water/Glassの任意Screen RefractionとLTCGI API v2を追加します。通常Shaderは1 ForwardBase drawを維持し、Screen Refractionは既定OFFです。

VPM依存:

- `com.fshader.core` 1.0.0
